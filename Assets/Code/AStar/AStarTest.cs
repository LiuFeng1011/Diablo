...
public class AStarTest : MonoBehaviour
{
	...
	void Start () {
        ...
        Vector2 startPosition = new Vector2((int)Random.Range(0, mapWidth), (int)Random.Range(0, mapHight));
        Vector2 endPosition = new Vector2((int)Random.Range(0, mapWidth), (int)Random.Range(0, mapHight));
